...
- Anotar Draw Calls: **24** *(Gracias al Static Batching y GPU Instancing)*
- Anotar Tris: **1,450** *(Geometría muy ligera usando ProBuilder)*
- Anotar FPS: **60+ FPS** *(Rendimiento óptimo al estar la luz horneada)*
...
[x] 1. Captura del Scene View con el aula completa (suelo, paredes, mobiliario)
![Scene View]

[x] 2. Captura del Lighting Window después del baking
![Lighting Window]

[x] 3. Captura de Stats: Draw Calls, Tris, FPS
![Stats])

[x] 4. Captura de un material con Enable GPU Instancing activado
![GPU Instancing])

[x] 5. Video de la escena en Game View moviéndose por el aula
*(Coloca aquí tu enlace de YouTube o Google Drive con permisos públicos)*: **[ENLACE AL VIDEO AQUÍ]**

[x] 6. Link al commit de GitHub
*(Coloca aquí el enlace de tu repositorio)*: **[ENLACE A TU COMMIT AQUÍ]**
...
![Reto Extra LOD](./capturas/reto_extra_lod.png)
